...
if answer is not None:
    ...
    if 1999 <= int(year) <= 2008:
        with st.chat_message("user"):
            ...
            if st.session_state.music != '刘廷禹 - 初升的太阳.ogg':
                play_music('刘廷禹 - 初升的太阳.ogg',3)
    ...
    if 2013 <= int(year) <= 2015:
        with st.chat_message("user"):
            ...
            if st.session_state.music != '胡夏 - 那些年.ogg':
                display_img('high school.jpg','假装是高中时期')
                play_music('胡夏 - 那些年.ogg')
    ...
    if year == '2021':
        with st.chat_message("user"):
            ...
            play_music('单依纯 - R&B All Night (Live).ogg', 2)
    ...
    if year == '2022':
        with st.chat_message("user"):
            ...
            play_music('李健 - 一往情深的恋人 (Live).ogg',3)
